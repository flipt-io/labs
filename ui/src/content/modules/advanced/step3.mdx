...
The `evaluationId` of the evaluation request is used to determine which variant is returned. This is used to ensure that the same user always gets the same variant. 
