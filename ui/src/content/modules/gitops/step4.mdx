...
Navigate your browser to the content of [pull request 2](http://localhost:3001/flipt/features/pulls/2/files).

Here we are defining the `chat-personas` feature flag in the same configuration as the advanced tutorial.
